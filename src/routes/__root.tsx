...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Portfolio of Pavani Naidu, Full Stack Developer and Computer Science student at Malla Reddy University." },
      { name: "author", content: "Pavani Naidu" },
